...
class StateMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new resource state class';
    ...
    protected function getStub(): string
    {
        return $this->option('model')
            ...
            : __DIR__ . '/stubs/resource-state.stub';
    }
    ...
    {
        return $rootNamespace.'\Ygg\Old\States';
    }
