...
import {isLocalizableValueField, localeObjectOrEmpty} from "../../../mixins/localize/utils";


jest.mock('../../../mixins/localize/utils', () => ({
...
describe('localize-form', () => {
    ...
    test('fieldLocalizedValue', () => {
        ...
        expect(localeObjectOrEmpty).toHaveBeenLastCalledWith({
            localeObject: {en: 'myTitle'},
            locale: 'en',
            value: 'ABC'
        });
