import localizeAutocomplete from '../../../mixins/localize/Autocomplete';
import localizeField from '../../../mixins/localize/field';
...
describe('localize-autocomplete', () => {
    ...
    test('localizedTemplateData', () => {
        ...
        wrapper.setProps({localized: true});
        expect(wrapper.vm.localizedTemplateData({
            title: {fr: 'FR text', en: 'EN text'},
            label: 'bbb'
        })).toEqual({title: 'EN text', label: 'bbb'});
    });
});
