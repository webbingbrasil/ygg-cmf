    ...
    <div class="YggResourceListPage">
        <template v-if="ready">
            <YggActionBarList
                ...
                :actions="allowedResourceActions"
                :forms="multiforms"
                ...
                @action="handleResourceActionRequested"
...
<script>
    import YggActionBarList from '../action-bar/ActionBarList.vue';
    ...
    export default {
        ...
        computed: {
            ...mapState('resource-list', {
                resourceKey: state => state.resourceKey,
            }),
        ...
        methods: {
            ...
            async init() {
                await this.$store.dispatch('resource-list/setResourceKey', this.$route.params.id);
                // legacy
                await this.get();
