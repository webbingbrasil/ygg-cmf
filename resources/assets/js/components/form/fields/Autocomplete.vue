<template>
    <div class="YggAutocomplete" :class="classes">
        <template v-if="ready">
            <multiselect
                class="YggAutocomplete__multiselect"
                :class="{ 'YggAutocomplete__multiselect--hide-dropdown':hideDropdown }"
                :value="value"
                :options="suggestions"
            ...
            >
                ...
                <template slot="loading">
                    <YggLoading :visible="isLoading" inline small />
                </template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            classes() {
                return [
                    { 'YggAutocomplete--remote': this.isRemote },
