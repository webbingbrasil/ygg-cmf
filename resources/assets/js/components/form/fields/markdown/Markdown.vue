<template>
    <div :class="{'YggMarkdown--read-only':readOnly}" class="YggMarkdown">
    ...
    export default {
        ...
        methods: {
            ...
            setMarkerActive({marker}) {
                this.codemirror.addLineClass(marker.lines[0], 'wrap', 'YggMarkdown__line--active');
            },

            setMarkerInactive({marker}) {
                this.codemirror.removeLineClass(marker.lines[0], 'wrap', 'YggMarkdown__line--active');
            },
            ...
            async insertUploadImage({replaceBySelection, data, isInsertion} = {}) {
                ...
                this.codemirror.addLineClass($uploader.marker.lines[0], 'wrap', 'YggMarkdown__upload-line');
                $uploader.marker.lines[0].on('delete', () => this.removeMarker($uploader, {
                    isCMEvent: true,
                    relativeFallbackLine: 1
                }));
